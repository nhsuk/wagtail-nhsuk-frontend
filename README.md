...
A wagtail implementation of the [NHS frontend v2.3.0](https://github.com/nhsuk/nhsuk-frontend) standard components.
...
```html
  <script type="text/javascript" src="{% static 'wagtailnhsukfrontend/js/nhsuk-2.3.0.min.js' %}" defer></script>
```
